...
/***********************************LED相关***********************************************/
#define LED1 &MODULE_P33, 8  //编码开关0引脚
#define LED2 &MODULE_P33, 9  //编码开关1引脚
#define LED3 &MODULE_P33, 10 //编码开关2引脚
#define LED4 &MODULE_P33, 11 //编码开关3引脚
int GetDip(int k); //获取某个编码器开关的io值
int GetKey(int k) ;//获取某个按钮开关的io值
void SetLed(int k, int light); //设置led灯
/***********************************按钮相关***********************************************/
#define K1 &MODULE_P20, 12 //K1
...
IFX_EXTERN uint32 SetMotor(uint32 direction, uint32 pwmDuty);//电机操作函数 方向+占空比（%）
IFX_EXTERN uint32 SetSteer(uint32 direction, uint32 pwmDuty);//舵机操作函数 方向+占空比（%）
