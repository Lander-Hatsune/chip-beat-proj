...
void STM_Int0Handler(void)
{
    ...
    TimeCount10ms++;
#ifdef SIMULATION
	IfxStm_increaseCompare(g_Stm.stmSfr, g_Stm.stmConfig.comparator, 10);
#else
	IfxStm_increaseCompare(g_Stm.stmSfr, g_Stm.stmConfig.comparator, TimeConst_10ms);
#endif
	/*
#ifdef SIMULATION
...
//    g_Stm.LedBlink ^= 1;
//
//    setOutputPin(&MODULE_P33, 9, g_Stm.LedBlink);
//    g_Stm.counter++;
//
//    I2C_write_write(0xaa, 0x55);
//
//}
//
//
...
#ifdef SIMULATION
    g_SrcSwInt.stmConfig.ticks      = 10;
#else
    g_Stm.stmConfig.ticks           = TimeConst_10ms;
#endif
